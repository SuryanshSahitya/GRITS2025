...
public class ScourceCam extends SubsystemBase {
  ...
  public ScourceCam(Drive drivebase) {
    this.drivebase = drivebase;
    camera = new PhotonCamera("ScourceCam");
    Transform3d kRobotToCam =
        new Transform3d(
            new Translation3d(Units.inchesToMeters(0), 0, Units.inchesToMeters(30.625)),
