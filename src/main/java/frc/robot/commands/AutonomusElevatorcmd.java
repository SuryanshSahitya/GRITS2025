...
public class AutonomusElevatorcmd extends Command {
   ...
   */
  public AutonomusElevatorcmd(elevatorsub elevator, int targetposition, boolean hi) {
    this.up = hi;
  ...
  public boolean isFinished() {
    ...
    return elevator.autoalighncheck(0);
  }
